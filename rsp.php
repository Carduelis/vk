...
<header>
  ...
  <ul class='header top-line'>
    ...
    <li id='goToWelcome' class="btn">
      <a href='/index.php' alt="Открыть страницу приветствия">Стартовая страница</a>
    </li>
...
<div id="wrapper">
<div id="root">
  <div id="container" class="container mayAddElement">
...
<script src="js/functions_rsp.js" type="text/javascript"></script>

<!-- Наполнение контентом -->
<script src="js/data_rsp/names.js" type="text/javascript"></script>
<script src="js/data_rsp/algorithms.js" type="text/javascript"></script>
<script src="js/data_rsp/scales.js" type="text/javascript"></script>
<script src="js/data_rsp/addcontrols.js" type="text/javascript"></script>
