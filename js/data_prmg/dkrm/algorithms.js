...
ex12 : {
	...
	nameOfExercise : 'Проверка выдачи сигнала аварии и аварийного переключения с рабочего комплекта РД на резервный',
	el1 : {
		click : '1',
		current : {
			inStack : 'stack0',
	...
	el2 : {
		...
		current : {
			inStack : 'stack0',
			inBlock : 'stack0_block22',
			onSide : 'stack0_block22_front',
			num : '16',
			type : 'toggler',
		},
		positions : {
	...
	el3 : {
		...
		positions : {
			position_1 : {
				state : '1',
				description : 'Установите переключатель РЕЖИМ в положение НАСТРОЙКА',
				action_1 : {
					inStack : 'stack0',
					inBlock : 'stack0_block1',
					onSide : 'stack0_block1_front',
