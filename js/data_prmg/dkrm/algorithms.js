...
/*	ex9 : {
	...
	ex12 : {
		message1 : {
			eN : '3',
			//pN : '1',
			text : 'На ПИУ КД должны включиться индикаторы НЕТ РЕЗЕРВА РД, АВАРИЯ РД соответствующего комплекта. Должен включиться звуковой сигнал и произойти переключение на резервный комплект РД.',
		},
		message2 : {
			eN : '4',
			pN : '3',
...
ex9 :  {
	...
	el2 : {
		...
		positions : {
			position_1 : {
				state : 'on',
				description : 'Ослабьте стопорящий винт с воротком на передающей антенне и с помощью регулировочного винта со штурвалом поверните антенну до появления сигнала «Авария» на ИКР.',
				action_1 : {
					inStack : 'stack0',
					inBlock : 'stack0_block1',
					onSide : 'stack0_block1_front',
	...
	el3 : {
		...
		positions : {
			position_1 : {
				state : '1',
				description : 'Разблокируйте КРМ, установив переключатель РЕЖИМ в положение НАСТРОЙКА',
				action_1 : {
					inStack : 'null',
					inBlock : 'null',
					onSide : 'null',
