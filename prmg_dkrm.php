    ...
    <ul>
      <li id="min_stack0">
        <div>
          ...
          <section class="ear left bottom" id="min_stack0_block27"><div side="front" id="min_stack0_block27_front"></div></section>
          <section class="ear right bottom" id="min_stack0_block28"><div side="front" id="min_stack0_block28_front"></div></section>
