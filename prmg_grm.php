...
<script src="js/data_prmg/grm/algorithms.js" type="text/javascript"></script>
<script src="js/data_prmg/grm/scales.js" type="text/javascript"></script>
<script src="js/data_prmg/grm/addcontrols.js" type="text/javascript"></script>
<script src="js/data_prmg/grm/names.js" type="text/javascript"></script>
